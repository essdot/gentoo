...
exports.skip = skip;
exports.take = take;
var marked0$0 = [accum, compose, dedupe, filter, map, pluck].map(regeneratorRuntime.mark);
...
function dedupe(gen, _eqFn) {
  var previousValue, valueSeen, eqFn, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, v, identity;
  ...
  }, marked0$0[2], this, [[7, 21, 25, 33], [26,, 28, 32]]);
}
...
function map(gen, fn, thisValue) {
  ...
  }, marked0$0[4], this, [[3, 14, 18, 26], [19,, 21, 25]]);
}
...
function pluck(gen, name) {
  ...
  }, marked0$0[5], this, [[3, 14, 18, 26], [19,, 21, 25]]);
}
