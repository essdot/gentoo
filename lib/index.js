...
var marked0$0 = [accum, compose, pluck, slice, map, filter].map(regeneratorRuntime.mark);
  ...
  return regeneratorRuntime.wrap(function slice$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        return context$1$0.delegateYield(gen, "t0", 2);
...
function filter(gen, fn, thisValue) {
  ...
  }, marked0$0[5], this, [[3, 15, 19, 27], [20,, 22, 26]]);
}
